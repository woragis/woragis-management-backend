...
export async function runTool(api, name, args) {
    switch (name) {
...
function stringParams(args, keys, nums = {}) {
    const out = {};
    for (const k of keys) {
...
export class AgentLoop {
    api;
    openai;
    constructor(openaiApiKey, api) {
        this.api = api;
        this.openai = new OpenAI({ apiKey: openaiApiKey });
    }
    async handleUserMessage(session, userText) {
